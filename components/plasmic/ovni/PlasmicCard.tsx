...
import sty from "./PlasmicCard.module.css"; // plasmic-import: Dsd636-ORe/css
...
export const PlasmicCard__ArgProps = new Array<ArgPropType>("content");
